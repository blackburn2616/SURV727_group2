...
```{r}
#Nicole
#mean, median, and variance from April 1,2020 - April 14, 2020
```
...
In the following, we request basic socio-demographic information (population, median age, median household income, income per capita) for all counties. The information about the variables used here can be found here: <https://api.census.gov/data/2022/acs/acs5/variables.html>.
...
```{r}
#Nicole
#compute mean of symptoms on April 1 for counties by above/below average hh income
```

```{r}
#Nicole
#relationship between hh_income and 
```
